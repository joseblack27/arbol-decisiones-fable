...
@onready var labels: Array[Label] = [
	...
	$MarginContainer/HBoxContainer/VBoxContainer/HBoxContainer/NivelHabilidad
]
...
@onready var level_skill  := $MarginContainer/HBoxContainer/VBoxContainer/HBoxContainer/NivelHabilidad
