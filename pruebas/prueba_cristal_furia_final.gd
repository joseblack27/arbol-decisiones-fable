# =============================================================================
# Regresión: al entrar en fase 4 ("Quiebre Final"), el Corazón de Cristal
# recarga TODAS sus habilidades multiplicador_furia_final (1.4) veces más
# rápido — mismo mecanismo que EnemigoGuardianQuebrado/EnemigoArañaReina.
# Mirror exacto de prueba_guardian_furia_final.gd.
#   godot --headless --path . --script res://pruebas/prueba_cristal_furia_final.gd
# =============================================================================
extends SceneTree
...
func _informar() -> bool:
	...
	print("PRUEBA CRISTAL FURIA FINAL %s" % ("OK" if _ok else "FALLIDA"))
