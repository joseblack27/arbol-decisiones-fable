# =============================================================================
# Regresión: al entrar en fase 4 ("Quiebre Final"), el Núcleo de la Forja
# recarga TODAS sus habilidades multiplicador_furia_final (1.4) veces más
# rápido — mismo mecanismo que EnemigoCorazonCristal/EnemigoGuardianQuebrado.
# Mirror exacto de prueba_cristal_furia_final.gd.
#   godot --headless --path . --script res://pruebas/prueba_forja_furia_final.gd
# =============================================================================
extends SceneTree
...
func _informar() -> bool:
	...
	print("PRUEBA FORJA FURIA FINAL %s" % ("OK" if _ok else "FALLIDA"))
