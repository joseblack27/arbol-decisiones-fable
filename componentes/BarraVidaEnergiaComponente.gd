...
## Barras de vida y energía del enemigo. Colócalo como hijo directo del
## enemigo (mismo padre que VidaComponente y, si tiene, EnergiaComponente):
## se busca a los hermanos por nombre, no hace falta cablear nada a mano. Si
## el enemigo no tiene EnergiaComponente (p. ej. el ratón), simplemente no
## dibuja esa segunda barra.
##
## El NOMBRE del mob ("Nv.X Nombre") y los ÍCONOS de estado (veneno,
## lentitud, aturdido...) NO viven acá — viven en Enemigo.gd (ver
## Enemigo._crear_nombre_mob), arriba del todo, encima del nombre. Quedaba
## raro que ocultar la energía pudiera arrastrar esas otras dos cosas con
## ella el día que alguien quisiera separarlas.
##
